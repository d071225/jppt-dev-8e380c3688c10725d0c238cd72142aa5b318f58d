...
public class EmptyView extends LinearLayout implements View.OnClickListener {
    @DrawableRes
    private int mEmptyLogo = R.drawable.icon_empty_data;
    @DrawableRes
    private int netErrorLogo = R.drawable.icon_network_error;
    ...
    private void initView() {
        ...
        mHandleView.setText(R.string.reload);
        mHandleView.setTextSize(16);
        int handTextColor = ContextCompat.getColor(getContext(), R.color.themeColor);
