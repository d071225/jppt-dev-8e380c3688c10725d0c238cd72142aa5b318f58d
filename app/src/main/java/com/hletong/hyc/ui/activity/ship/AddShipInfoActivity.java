...
public class AddShipInfoActivity extends BaseActivity implements BottomSelectorDialog.OnItemSelectedListener<DictionaryItem> {
    //船舶类型
    ...
    EditText etShipFull;
    //净吨位
    @BindView(R.id.ship_nt_ton)
    EditText etShipNtton;
    //载重吨位
    ...
    public int getLayoutId() {
        return R.layout.activity_add_ship_info;
    }
    ...
    public void initView(@Nullable Bundle savedInstanceState) {
        ...
        if (mShipInfo != null) {
            ...
            etShipNtton.setText(mShipInfo.getNt_ton());
        ...
        switch (v.getId()) {
            ...
            case R.id.submit:
                if (validate()) {
                    ...
                    mShipInfo.setNt_ton(getTextValue(etShipNtton));
    ...
    private boolean validate() {
        ...
        if (mShipInfo.getShip_type() == null) {
            ...
            showMessage("请输入满载吃水");
        } else if (StringUtil.isTrimBlank(getTextValue(etShipNtton))) {
            showMessage("请输入净吨位");
