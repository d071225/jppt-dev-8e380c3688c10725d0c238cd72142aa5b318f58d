...
public class JSONUtils {
    ...
    public static <T> T fromJson(String json, TypeToken<T> token,
                                 String datePattern, Object typeAdapter) {
        if (isBlank(json)) {
            return null;
        }
        if (isBlank(datePattern)) {
        ...
        if (typeAdapter != null)
            builder.registerTypeAdapter(token.getType(), typeAdapter);//注册自定义解析器
     ...
     */
    public static <T> T fromJson(String json, TypeToken<T> token) {
        return fromJson(json, token, null, null);
    }
     ...
     * @param json
     * @param token 返回类型
     * @param typeAdapter 自定义解析器
     * @param <T>
     * @return
     */
    public static <T> T fromJson(String json, TypeToken<T> token, Object typeAdapter) {
        return fromJson(json, token, null, typeAdapter);
    }
