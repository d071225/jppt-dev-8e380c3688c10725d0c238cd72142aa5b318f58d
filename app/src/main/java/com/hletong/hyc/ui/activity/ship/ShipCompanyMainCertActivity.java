 ...
 */
public class ShipCompanyMainCertActivity extends BaseActivity implements CertInfoContract.View {
    ...
    private ArrayList<PaperPhoto> mCompanyPaperPhotos = PapersHelper.getCompanyShip();
    ...
    public int getLayoutId() {
        return R.layout.activity_ship_company_main_certificate;
    }
    //是否主动补充
